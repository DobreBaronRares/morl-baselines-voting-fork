"""Outer-loop MOSARSA algorithm (uses multiple weights)."""
...
from morl_baselines.single_policy.ser.mo_sarsa import MOSARSA


class MPMOSARSA(MOAgent):
    """Multi-policy MOSARSA: Outer loop version of mo_sarsa.
    ...
    def __init__(
        ...
        experiment_name: str = "MultiPolicy MO SARSA",
        wandb_entity: Optional[str] = None,
        seed: Optional[int] = None,
        log: bool = True,
    ):
        """Initialize the Multi-policy MOSARSA algorithm.
