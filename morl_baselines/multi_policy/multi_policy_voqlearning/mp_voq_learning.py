"""Outer-loop VoQ-learning algorithm (uses multiple weights)."""
...
class MPVoQLearning(MOAgent):
    """Multi-policy VoQ-Learning: Outer loop version of voq_learning.

    MPMOQL Paper: Paper: K. Van Moffaert, M. Drugan, and A. Nowe, Scalarized Multi-Objective Reinforcement Learning: Novel Design Techniques. 2013. doi: 10.1109/ADPRL.2013.6615007.
    """
    ...
    def __init__(
        ...
        experiment_name: str = "MultiPolicy VoQ-Learning",
        wandb_entity: Optional[str] = None,
        seed: Optional[int] = None,
        log: bool = True,
    ):
        """Initialize the Multi-policy VoQ-learning algorithm.
    ...
    def eval(self, obs: np.array, w: Optional[np.ndarray] = None) -> int:
        """Choose the best policy for w and follows it."""
