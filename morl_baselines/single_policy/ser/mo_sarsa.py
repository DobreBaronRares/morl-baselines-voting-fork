"""Scalarized SARSA for single policy multi-objective reinforcement learning."""
...
class MOSARSA(MOPolicy, MOAgent):
    """Scalarized SARSA for single policy multi-objective reinforcement learning.
    ...
    def __init__(
        ...
        experiment_name: str = "MO SARSA",
        wandb_entity: Optional[str] = None,
        log: bool = True,
        seed: Optional[int] = None,
        parent_rng: Optional[np.random.Generator] = None,
    ):
        """Initializes the MOSARSA algorithm.
