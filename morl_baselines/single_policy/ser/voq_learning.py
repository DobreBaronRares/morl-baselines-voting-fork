"""Voting Q-learning for single policy multi-objective reinforcement learning."""
...
class VoQLearning(MOPolicy, MOAgent):
    """Voting Q learning for single policy multi-objective reinforcement learning.
    ...
    def __init__(
        ...
        experiment_name: str = "VoQ-Learning",
        wandb_entity: Optional[str] = None,
        log: bool = True,
        seed: Optional[int] = None,
        parent_rng: Optional[np.random.Generator] = None,
    ):
        """Initializes the VoQ-learning algorithm.
